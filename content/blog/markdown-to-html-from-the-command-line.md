...
Two numbers shape how you call it: 4 MB a document, 60 requests a minute per caller. Forty files clear that easily; thousands need a sleep, or one merged document.
